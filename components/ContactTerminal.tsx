    ...
    <section id="contact" className="py-24 px-8 max-w-4xl mx-auto">
      <div className="mb-12 text-center relative">
        ...
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-2 uppercase">
          Establish{" "}
          <span className="text-primary hologram-glow">Connection</span>
        </h2>
      ...
      <div className="glass-panel rounded-xl p-8 md:p-12 relative overflow-hidden group border-primary/20">
        ...
        {status === "success" ? (
          <div className="py-20 text-center animate-pulse">
            <span className="material-icons text-emerald-400 text-6xl mb-4">
              check_circle
            </span>
            ...
            <p className="text-slate-400 mt-2">
              Data payload received and encrypted. Response pending.
            </p>
            <button
          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="relative">
                <label className="block text-[10px] tracking-widest text-primary uppercase mb-2 font-bold">
                  Ident_Name
                </label>
                <input
                  required
            ...
            {status === "error" && (
              <p className="text-red-500 text-xs font-mono mt-4 text-center">
