    ...
    <div className="min-h-screen grid-bg relative">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        ...
        <div className="absolute left-6 top-1/2 -translate-y-1/2 hidden xl:flex flex-col items-center gap-12 opacity-20">
          <div className="rotate-90 text-[10px] font-mono tracking-[0.5em] whitespace-nowrap text-primary uppercase">
            System_Parameters
          </div>
        ...
        <footer className="border-t border-primary/10 bg-background-dark/80 backdrop-blur-md py-12 px-8">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex flex-col items-center md:items-start">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-bold tracking-tighter text-lg uppercase">
                  Ahsan_Core <span className="text-primary">v4.0</span>
                </span>
              </div>
              <p className="text-[10px] text-slate-500 uppercase tracking-widest font-mono">
                © 2026 Ahsan Zahoor // Node_ID: 882-Alpha
              </p>
            </div>

            <div className="flex items-center gap-6">
              <a
                href="https://github.com/codewithahsanzahoor"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 border border-primary/20 rounded-full text-slate-400 hover:text-primary hover:border-primary transition-all bg-primary/5 group"
              >
                <span className="text-sm font-mono tracking-widest uppercase group-hover:text-white transition-colors">
                  GitHub
                </span>
              ...
              <a
                href="https://www.linkedin.com/in/muhammadahsanzahoor/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-4 py-2 border border-primary/20 rounded-full text-slate-400 hover:text-primary hover:border-primary transition-all bg-primary/5 group"
              >
            ...
            <div className="flex items-center gap-3 bg-primary/5 border border-primary/20 px-4 py-2 rounded-full">
              ...
              <span className="text-[10px] font-bold text-primary tracking-[0.2em] uppercase font-mono">
